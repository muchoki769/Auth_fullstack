...
export default function VerifyEmailPage() {
    ...
    return(
        <div className="flex items-center justify-center flex-col m-2  min-h-screen  py-2 ">
            ...
            {error && (
                <div>
                    <h2 className="text-2xl  bg-red-500 rounded-md py-2 px-4 m-2">Error !, Email Not Verified, please sign up or token has expired</h2>
